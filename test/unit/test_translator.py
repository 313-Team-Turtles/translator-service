...
@patch.object(src.translator, 'dummy_translate')
def test_llm_mandarin_text(mocker):
    mandarin_text = "这是一条中文消息"
    mocker.return_value = "This is a Chinese message"
...
@patch.object(src.translator, 'dummy_translate')
def test_llm_numeric_input(mocker):
    mocker.return_value = "12345"
...
@patch.object(src.translator, 'dummy_translate')
def test_llm_empty_string(mocker):
    mocker.return_value = ""
...
@patch.object(src.translator, 'dummy_translate')
def test_llm_special_characters(mocker):
    special_characters = "!@#$%^&*()_+"
    mocker.return_value = "!@#gibberish)_+"
...
@patch.object(src.translator, 'dummy_translate')
def test_llm_none_return(mocker):
